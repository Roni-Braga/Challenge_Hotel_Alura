...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		private void CadastraReserva() {
			...
			reserva.CadastraReserva(NovaReserva);
						
			JOptionPane.showMessageDialog(contentPane, "Reservado com Sucesso");
			RegistroHospede Hospede = new RegistroHospede(NovaReserva.getId());
